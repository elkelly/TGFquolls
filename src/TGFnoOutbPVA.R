...
for(k in yr) {
  ...
  for(j in nI) {
    for (i in 1:n) {
      test<-TGF(demPars = pars, nP = 10, nN = 10, nI = 10, W0 = 0.09, s0=0.38, h2=0.2, burnIn=10, noSel=20, selGens=50, TGFtime=k, W1=0.9, nIntr=j, outbreeding=FALSE, nl=10, H2=1, alpha=1)    
